...
<form action="<?php echo site_url('admin/lessons/'.$param2.'/add'); ?>" method="post" enctype="multipart/form-data">
	...
	<!--- Vishnu added below code -->
	<div class="form-group">
            <label for="lesson_provider_for_files"><?php echo get_phrase('lesson_provider'); ?>( <?php echo get_phrase('for_web_application'); ?> )</label>
            <select class="form-control select2" data-toggle="select2" name="lesson_provider_for_files" id="lesson_provider_for_files" >
                <option value=""><?php echo get_phrase('select_lesson_provider'); ?></option>
                <option value="youtube"><?php echo get_phrase('youtube'); ?></option>
                <option value="vimeo"><?php echo get_phrase('vimeo'); ?></option>
	   ...
	   <div class="form-group">
			...
			<input type="text" id = "video_url_for_files" name = "video_url_for_files" class="form-control"  placeholder="<?php echo get_phrase('this_video_will_be_shown_on_web_application'); ?>">
		</div>
        <div class="form-group">
