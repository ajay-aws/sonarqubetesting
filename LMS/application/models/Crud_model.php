  ...
  public function add_lesson()
  {
    ...
    if ($lesson_type == 'video') {
      ...
      /*  $video_details = $this->video_model->getVideoDetails($data['video_url']);*/
		/*** vishnu commented code ***/
      /*  $data['video_type'] = $video_details['provider'];*/
        $data['video_type'] = $this->input->post('lesson_provider');
	   //  print_r($_POST);exit;
      }
      ...
      if ($_FILES['attachment']['name'] == "") {
		...
		$data['video_url'] = $this->input->post('video_url_for_files');
		$data['video_type'] = $this->input->post('lesson_provider_for_files');
